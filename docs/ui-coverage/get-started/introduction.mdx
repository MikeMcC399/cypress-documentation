...
Because Cypress Accessibility uses data captured through Cypress Test Replay, it is subject to any [limitations of Test Replay](/faq/questions/cloud-faq#Is-everything-captured-and-replayed-in-Test-Replay) data captured and browser support.
