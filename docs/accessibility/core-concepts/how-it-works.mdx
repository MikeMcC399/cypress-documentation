...
Because Cypress Accessibility uses data captured through Cypress Test Replay, it is subject [Test Replay limitations](/faq/questions/cloud-faq#Is-everything-captured-and-replayed-in-Test-Replay).
